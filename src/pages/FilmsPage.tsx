...
import { fetchFilms } from "../services/filmApi"; // Update this line according to your API fetching logic
  ...
  useEffect(() => {
    const loadFilms = async () => {
      try {
        ...
        console.log("Returned Film Data:", filmData);
        setFilms(filmData);
        setLoading(false);
      } catch (error) {
              ...
              <Col key={index} xs={12} md={6} lg={4} className="mb-4">
                <Card>
                  ...
                  <Card.Body>
                    ...
                    <Button variant="primary" href="https://youtu.be/xvFZjo5PgG0" target="_blank" rel="noreferrer" className="btn-darkblue">
                      Watch Short Video
                    </Button>
                  </Card.Body>
                </Card>
